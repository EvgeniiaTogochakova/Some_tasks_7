...
int myRows = GetValueFromUser("Я создаю матрицу по вашим данным. Сколько в ней будет строк: ");
int myColumns = GetValueFromUser("столбцов: ");
...
Console.WriteLine("Готово среднее арифметическое по каждому столбцу");
